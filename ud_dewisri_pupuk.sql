...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 15, 2019 at 12:10 PM
...
CREATE TABLE `history_add_pupuk` (
  ...
  `ongkos_kirim` varchar(100) DEFAULT NULL,
...
('GDAAAA000001', 1, '1292-PSI-12-1KS', 'P 9138 DK', 'baron', '25.00', 'kg', 'Kiki', '100', '2019-01-08 13:51:13', 5, 0);
...
CREATE TABLE `pembayaran` (
  ...
  `tanggal_pembayaran_awl` date NOT NULL,
...
INSERT INTO `penjualan` (`id_penjualan`, `tanggal_penjualan`, `total_harga`, `diskon`, `harga_keseluruhan`, `status_konfirmasi_id_konfirmasi`, `sales_id_sales`, `blok_id_blok`, `pekerjaan_id_pekerjaan`, `pemohon_id_pemohon`, `perkiraan_id_perkiraan`, `supir_ud_dewisri_id_supir`, `no_do_penjualan`, `supir_pengantar`, `tanggal_kirim`, `pengirim`) VALUES
('GDAAAA000001', '2019-01-14 18:40:54', 380000, 0, 380000, 4, 2, 2, 4, 1, 3, 2, 'DHD128192', NULL, '2019-01-16 18:40:54', 'Shani');
...
(9, 'Organic Green SF-130 tree', '105.00', '90000', 'dede', 4, 2),
...
ALTER TABLE `penerimaan`
  ADD PRIMARY KEY (`id_penerimaan`,`pembayaran_id_pembayaran`),
  ADD KEY `fk_penerimaan_pembayaran1_idx` (`pembayaran_id_pembayaran`);
...
--
ALTER TABLE `blok`
  ADD CONSTRAINT `fk_blok_kebun1` FOREIGN KEY (`kebun_id_kebun`) REFERENCES `kebun` (`id_kebun`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `kebun`
  ADD CONSTRAINT `fk_kebun_kota1` FOREIGN KEY (`kota_id_kota`) REFERENCES `kota` (`id_kota`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `pembayaran`
--
ALTER TABLE `pembayaran`
  ADD CONSTRAINT `fk_pembayaran_penjualan1` FOREIGN KEY (`penjualan_id_penjualan`) REFERENCES `penjualan` (`id_penjualan`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `penerimaan`
  ADD CONSTRAINT `fk_penerimaan_pembayaran1` FOREIGN KEY (`pembayaran_id_pembayaran`) REFERENCES `pembayaran` (`id_pembayaran`) ON DELETE NO ACTION ON UPDATE NO ACTION;
